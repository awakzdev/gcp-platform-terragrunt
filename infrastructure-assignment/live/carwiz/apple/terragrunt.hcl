...
terraform {
  ...
  source = "git::git@gitlab.com:mycompany/iac/infrastructure-definition.git//${local.dir_name}?ref=${local.release_ref}"
...
inputs = {
  ...
  db_autorized_networks    = [
    ...
    {name = "developer-2", value = "10.0.0.0/16"},
    {name = "developer-3-home", value = "10.0.0.0/16"},
    {name = "developer-4-home", value = "10.0.0.0/16"},
    {name = "developer-5-home", value = "10.0.0.0/16"},
    {name = "argo-workflow",    value = "10.0.0.0/16"},
    {name = "developer-6-home", value = "10.0.0.0/16"},
    {name = "developer-7-home", value = "10.0.0.0/16"},
    {name = "guest-access",     value = "10.0.0.0/16"}
    ]
  db_replica               = {tier = "db-custom-4-6144"}
